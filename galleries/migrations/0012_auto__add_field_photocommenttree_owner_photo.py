...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'galleries_photocommenttree', 'owner_photo',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=11, related_name='comment_tree_2', unique=True, to=orm['galleries.ImageModel']),
                      keep_default=False)
    ...
    models = {
        ...
        u'galleries.photocommenttree': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner_photo': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'comment_tree_2'", 'unique': 'True', 'to': u"orm['galleries.ImageModel']"}),
