...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoCommentTree'
        db.create_table(u'galleries_photocommenttree', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner_photo', self.gf('django.db.models.fields.related.OneToOneField')(related_name='comment_tree', unique=True, to=orm['galleries.ImageModel'])),
        ))
        db.send_create_signal(u'galleries', ['PhotoCommentTree'])

        # Adding model 'PhotoComment'
        db.create_table(u'galleries_photocomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_comments', null=True, to=orm['members.Member'])),
            ('posted_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('tree', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', null=True, to=orm['galleries.PhotoCommentTree'])),
        ))
        db.send_create_signal(u'galleries', ['PhotoComment'])


    def backwards(self, orm):
        # Deleting model 'PhotoCommentTree'
        db.delete_table(u'galleries_photocommenttree')

        # Deleting model 'PhotoComment'
        db.delete_table(u'galleries_photocomment')
    ...
    models = {
        ...
        u'galleries.photocommenttree': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner_photo': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'comment_tree'", 'unique': 'True', 'to': u"orm['galleries.ImageModel']"})
        },
