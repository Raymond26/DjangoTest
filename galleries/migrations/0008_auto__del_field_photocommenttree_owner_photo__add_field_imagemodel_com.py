...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoCommentTree.owner_photo'
        db.delete_column(u'galleries_photocommenttree', 'owner_photo_id')

        # Adding field 'ImageModel.comment_tree'
        db.add_column(u'galleries_imagemodel', 'comment_tree',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owner_image', null=True, to=orm['galleries.PhotoCommentTree']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PhotoCommentTree.owner_photo'
        db.add_column(u'galleries_photocommenttree', 'owner_photo',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=11, related_name='comment_tree', unique=True, to=orm['galleries.ImageModel']),
                      keep_default=False)

        # Deleting field 'ImageModel.comment_tree'
        db.delete_column(u'galleries_imagemodel', 'comment_tree_id')
